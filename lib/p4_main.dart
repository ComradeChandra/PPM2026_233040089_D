...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _bukaForm({Catatan? initial}) async {
    await Navigator.pushNamed(context, '/p4_form', arguments: initial);
    _muatUlang();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Catatan (SQLite)'),
            ...
            itemBuilder: (_, i) {
              ...
              return Card(
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.pushNamed(context, '/p4_detail', arguments: c);
                  },
                ),
              );
            },
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              await Navigator.pushNamed(context, '/p4_form', arguments: catatan);
