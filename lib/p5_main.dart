...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _bukaForm({Catatan? initial}) async {
    await Navigator.pushNamed(context, '/p5_form', arguments: initial);
    _muatUlang();
  }
  ...
  Future<void> _konfirmasiHapus(Catatan c) async {
    final yakin = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('"${c.judul}" akan dihapus dari server.'),
        actions: [
          TextButton(
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Catatan>>(
        ...
        builder: (context, snapshot) {
          ...
          if (data.isEmpty) return const Center(child: Text('Belum ada catatan di server.'));
            ...
            itemBuilder: (_, i) {
              ...
              return Card(
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.pushNamed(context, '/p5_detail', arguments: c);
                  },
                ),
              );
            },
...
class _CatatanFormPageState extends State<CatatanFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(_isEdit ? 'Edit Catatan (API)' : 'Tambah Catatan (API)')),
      body: Form(
        key: _formKey,
        child: ListView(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              await Navigator.pushNamed(context, '/p5_form', arguments: catatan);
